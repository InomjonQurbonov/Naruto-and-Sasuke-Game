...
walkRight = [pygame.image.load('NR2.png'),pygame.image.load('NR3.png'),pygame.image.load('NR1.png')]
walkLeft = [pygame.image.load('NL2.png'),pygame.image.load('NL3.png'),pygame.image.load('NL1.png')]
...
bgm = pygame.mixer.music.load("theme.wav")
	...
	def draw(self,win):
		...
		if self.health >0:
			...
			if not(self.standing):
				...
				if self.right:
					win.blit(pygame.image.load('NR1.png'), (self.x, self.y))
				else:
					win.blit(pygame.image.load('NL1.png'), (self.x, self.y))
			...
			win.blit(pygame.image.load('Nd.png'),(self.x,self.y))	
...
class weapons():
	...
	def draw(self,win):
		win.blit(pygame.image.load('shur.png'),(self.x,self.y))
...
class enemy():
	...
	walkRightS = [pygame.image.load('SR2.png'),pygame.image.load('SR3.png'),pygame.image.load('SR1.png')]
	walkLeftS = [pygame.image.load('SL2.png'),pygame.image.load('SL3.png'),pygame.image.load('SL1.png')]
	...
	def draw(self, win):
		...
		if self.health >0:
			...
			win.blit(text,(180,200))
			win.blit(pygame.image.load('Sd.png'),(self.x,self.y))
		pygame.draw.rect(win, (255,0,0),self.hitbox,2)
